...
def sexO(sexo):
    if sexo.get() == 1:
        ...
        return "NO SELECCIONO SEXO"


def DatosUser():
    if nomIuser.get() == "" or apellIuser.get() == "" or edadIuser.get() == "" or sexo.get()==0:
        ...
        labelSexo = Label(frame1)
        labelSexo.config(text=sexO(sexo))
        labelSexo.grid(column=2, row=4)
...
nomIuser.grid(column=2, row=1, padx=5)
...
apellIuser.grid(column=2, row=2, padx=5)
...
edadIuser.grid(column=2, row=3, padx=5)
# ------------Radiobuttons--------------------------

sexoLabel = Label(frame1, bd=1, text="Sexo: ", fg="red", )
sexoLabel.grid(column=0, row=4)

sexo = IntVar()
sexoM = Radiobutton(frame1, bd=2, text="Masculino", variable=sexo, value=1)
sexoM.grid(column=2, row=5, sticky="w")

sexoF = Radiobutton(frame1, bd=2, text="Femenino", variable=sexo, value=2)
sexoF.grid(column=2, row=6, sticky="w")

sexoNN = Radiobutton(frame1, bd=2, text="Otro", variable=sexo, value=3)
sexoNN.grid(column=2, row=7, sticky="w")
